...
fn main() {
    ...
    //
    things::print_difference(coords.0, coords.1); // Uncomment and finish this line
    ...
    things::print_array(coords_arr); // and pass it in here (this line doesn't need to change)
    ...
    //
    println!("the value of mess at 2 {}", mess.2[1].0);
    things::on_off(mess.2[1].0);
